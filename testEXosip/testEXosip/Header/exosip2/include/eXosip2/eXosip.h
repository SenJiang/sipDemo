 ...
 */
  typedef enum eXosip_event_type {
    ...
    EXOSIP_MESSAGE_ANSWERED,         /**25< announce a 200ok  */
    ...
    EXOSIP_SUBSCRIPTION_NOANSWER,          /**30< announce no answer              */
    ...
    EXOSIP_SUBSCRIPTION_SERVERFAILURE,     /**35< announce a server failure       */
    ...
    EXOSIP_NOTIFICATION_PROCEEDING,        /**40< announce a 1xx                  */
    ...
    EXOSIP_NOTIFICATION_GLOBALFAILURE,     /**45< announce a global failure       */
